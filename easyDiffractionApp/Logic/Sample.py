...
class SampleLogic(QObject):
    ...
    def _defaultCWJob(self):
        job = Powder1DCW('default_job_9999', self._data_storage, phases=self._phases.phases)
    ...
    def _defaultCWPolJob(self):
        job = PolPowder1DCW('default_job_8888', self._data_storage, phases=self._phases.phases)
    ...
    def _defaultTOFJob(self):
        job = Powder1DTOF('default_job_7777', self._data_storage, phases=self._phases.phases)
